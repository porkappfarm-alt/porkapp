...
mixin _$Profile {
  ...
  ProfileRole get role => throw _privateConstructorUsedError;
...
class _$ProfileImpl extends _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, email: $email, role: $role, status: $status, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
